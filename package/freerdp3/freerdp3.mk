...
FREERDP3_CONF_OPTS += -DWITH_FFMPEG=OFF -DWITH_SWSCALE=OFF
endif
...
FREERDP3_CONF_OPTS += -DWITH_SIMD=ON
else
...
FREERDP3_CONF_OPTS += -DWITH_SERVER=OFF
FREERDP3_CONF_OPTS += -DWITH_SERVER_INTERFACE=OFF
endif

ifneq ($(BR2_PACKAGE_FREERDP3_CLIENT_X11)$(BR2_PACKAGE_FREERDP3_CLIENT_WL)$(BR2_PACKAGE_FREERDP3_CLIENT_SDL),)
FREERDP3_CONF_OPTS += -DWITH_CLIENT=ON
FREERDP3_CONF_OPTS += -DWITH_CLIENT_INTERFACE=ON
else 
FREERDP3_CONF_OPTS += -DWITH_CLIENT=OFF
FREERDP3_CONF_OPTS += -DWITH_CLIENT_INTERFACE=OFF
endif
...
ifeq ($(BR2_PACKAGE_FREERDP3_CLIENT_SDL),y)
FREERDP3_CONF_OPTS += -DWITH_CLIENT_SDL=ON
FREERDP3_CONF_OPTS += -DWITHOUT_FREERDP_3x_DEPRECATED=OFF
else
FREERDP3_CONF_OPTS += -DWITH_CLIENT_SDL=OFF
endif
...
define FREERDP3_RM_SHADOW_SERVER
	...
	rm -f $(TARGET_DIR)/usr/bin/freerdp-shadow-cli
endef
